...
RcppExport SEXP _SQUIC_SQUIC_RR(SEXP data_trainSEXP, SEXP lambdaSEXP, SEXP max_iterSEXP, SEXP drop_tolSEXP, SEXP term_tolSEXP, SEXP verboseSEXP, SEXP modeSEXP, SEXP MSEXP, SEXP X0SEXP, SEXP W0SEXP, SEXP data_testSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(SQUIC_RR(data_train, lambda, max_iter, drop_tol, term_tol, verbose, mode, M, X0, W0, data_test));
...
static const R_CallMethodDef CallEntries[] = {
    {"_SQUIC_SQUIC_RR", (DL_FUNC) &_SQUIC_SQUIC_RR, 11},
